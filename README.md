...
- `index.html`: política de privacidad bilingüe.
...
4. Usa la URL pública resultante en:
   - `Privacy Policy URL` de App Store Connect.
   - `Privacy policy` de Google Play Console.
   - Si quieres, también puedes reutilizar esa misma URL para cualquier referencia pública de privacidad.
